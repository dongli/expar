module API
  module V1
    class Figures < Grape::API
      ...
      params do
        requires :diag_id, type: Integer, desc: 'Diagnostics id.'
      ...
      post 'create_figure' do
        ...
        strong_params = ActionController::Parameters.new({figure: {diag_id: params[:diag_id],
                                                                   title: params[:title],
                                                                   file: params[:file],
                                                                   comment: params[:comment]}})
        figure = Figure.new(strong_params.
                            require(:figure).
                            permit(:diag_id,
                                   :title,
                                   :file,
        ...
        if figure.save
          ...
          error!('Failed to create figure!', 400)
        end
      end
    end
  end
